# The encryption() function from line 30 to 57 is designed to hide a secret message inside 
# an image file using the LSB (Least Significant Bit) method from the 
# steghide or stepic module (here it's likely using lsb from steghide or 
# stegano.lsb).
